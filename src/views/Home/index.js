...
const Toast = () => {
  return (
    <div>
      {/* <div className="toast-header">Mandatory Token Upgrade</div>
      <div className="toast-body">
        Please connect your wallet to upgrade your CRSS tokens, using the "Convert Tokens" function.
      </div> */}
      <div className="toast-header">Dear Community</div>
      <div className="toast-body">
      Following the exploit on 18th and 19th Jan 2022, we have halted token conversion and would you ask you leave any balances as they are. 
This is for your own safety and in order to ensure we can compensate users appropriately.
      </div>
    </div>
  );
}
                    ...
                    address === null ?
                      (<li className="nav-item in-menu">
                        ...
                        <>
                          ...
                          <li className="nav-item in-menu">
                            {!showPresaleInfo && (
                              <button onClick={showPresale} className="btn btn_primary buy-token-button btn_signIN">
                                {secondsRemaining > 0 ? 'Buy Tokens' : 'Tokens'}
                              </button>
                            )}
                          </li>
                        </>
