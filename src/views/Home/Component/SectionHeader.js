...
const crssContract = `https://bscscan.com/address/0x99FEFBC5cA74cc740395D65D384EDD52Cb3088Bb`
  ...
  const carouselItems = [
    {
      ...
      title: secondsRemaining > 0 ?
        'Pre-Sale Round 2: Open' :
        'Pre-Sale Round 2: Finished',
    ...
    return (
      ...
      >
        <div className="header_presale_board_round2">
          <div className={`presale_title${index}`}>
            <h5>{item.title}</h5>
          </div>
          ...
          <div className="presale_info">
            ...
            <div className={`presale_info_rectangle long_width${index}`}>
          ...
          <div className="presale_tips" style={{ marginTop: `${index === 0 ? '10px' : '40px'}` }}>
                ...
                <Row className="mt-3">
                  ...
                  <Col sm={4} xs={6}>
                    <a className="btn btn_primary p-2 btn_pitchdeck contract-btn custom-btn" href={crssContract} target="_blank" rel="noreferrer">
                      <img className="scan_img" src={bscscanImg} alt="" />CRSS V1.1
                    </a>
                  </Col>
                </Row>
                <Row className="mt-3">
